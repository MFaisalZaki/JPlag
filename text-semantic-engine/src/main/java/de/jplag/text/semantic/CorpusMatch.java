 ...
 * @param source which signal retrieved it: {@code "lexical"}, {@code "semantic"}, or {@code "ensemble"}.
 */
public record CorpusMatch(String documentId, double score, String source) {
}
